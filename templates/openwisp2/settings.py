...
{% if openwisp2_radius and openwisp2_radius_periodic_tasks %}
    ...
    "delete_old_radiusbatch_users": {
        ...
        "kwargs": {
            "older_than_days": {{ openwisp2_radius_delete_old_radiusbatch_users }}
        },
        "relative": True,
    },
...
{% endif %}
{% endif %}
{% if openwisp2_usage_metric_collection and openwisp2_usage_metric_collection_periodic_tasks %}
    "send_usage_metrics": {
